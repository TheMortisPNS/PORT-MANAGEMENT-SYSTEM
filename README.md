...
| `update_status.php` | Ενημερώνει την κατάσταση (status) και τις ώρες άφιξης/αναχώρησης του πλοίου.
| `helpers.php` | Βοηθητικές συναρτήσεις για υπολογισμούς κόστους, ημερομηνιών και ασφάλεια δεδομένων.
| `get_ship.php` | Ανακτά και επιστρέφει τα δεδομένα ενός πλοίου σε μορφή JSON.
